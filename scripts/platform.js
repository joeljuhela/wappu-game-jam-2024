...
var platform = Bodies.rectangle(width / 2, height - 150, platform_width, platform_width, {...platform_options,  render: {
  fillStyle: '#9f338e'
}});
...
var ground_options = {
    ...
    friction: 0.5,
    render: {
        fillStyle: 'transparent', // Set the fill color of the rectangle
